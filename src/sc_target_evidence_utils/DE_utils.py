...
def celltype_marker_targets(pbulk_adata: anndata.AnnData, 
    ...
    # else:
    DE_design = f'~ (0 + high_level_cell_type_ontology_term_id) + {confounders_str} + n_cells'            
    ...
    celltype_de_results = _run_glmGamPoi_DE(
            ...
            design = DE_design,
            ref_level = None,
            contrast = ['high_level_cell_type_ontology_term_id' + ct_term for ct_term in ct_categories],
            n_hvgs = n_hvgs
            )
